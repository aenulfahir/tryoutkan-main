-- =====================================================
-- UPDATE: Add notifications to purchase_tryout_package function
-- =====================================================

-- Update purchase_tryout_package function to create notifications
...
BEGIN
  ...
  INSERT INTO public.notifications (
    ...
    'purchase',
    'Pembelian Paket Tryout Baru',
    v_user_name || ' telah membeli paket "' || v_package_title || '"',
    json_build_object(
      'user_id', p_user_id,
      'user_name', v_user_name,
      'package_id', p_tryout_package_id,
      'package_title', v_package_title,
      'purchase_price', v_package_price,
      'purchased_at', NOW()
    ),
    false,
    NOW(),
